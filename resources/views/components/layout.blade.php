...
<body class="mb-48 text-white">
    ...
    <nav class="flex justify-between items-center mb-4 px-6 py-4 bg-lightNavy shadow-md">
        ...
        <ul class="flex space-x-6 mr-6 text-lg">
            <li>
                <a href="/register" class="hover:text-skyBlue"><i class="fa-solid fa-user-plus"></i> Register</a>
            </li>
            <li>
                <a href="/login" class="hover:text-skyBlue"><i class="fa-solid fa-arrow-right-to-bracket"></i>
                    Login</a>
            </li>
        </ul>
    </nav>
